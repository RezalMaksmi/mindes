        ...
        <form action="" className="bg-[#E0E9EF] rounded-lg w-fit ">
          ...
          <div className=" flex flex-col gap-5 px-3 py-3 justify-center items-center">
            <Input
              ...
              className="bg-white w-[300px] md:w-[500px] rounded-md p-2"
            />
            <Input
              placeholder="Masukkan Email anda"
              className="bg-white w-[300px] md:w-[500px] rounded-md p-2"
            />
            <Input typeInput="InputMessage" placeholder="Masukkan Pesan Anda" />
            <Button type="iconButton" text="Kirim" />
          </div>
        </form>
        <div className="flex flex-col gap-5 justify-center items-center">
          <div className="w-[300px] h-[220px] rounded-md bg-[#E0E9EF] p-3 flex flex-col gap-5 items-left justify-center ">
          ...
          <div className="w-[300px] h-[220px] rounded-md bg-[#E0E9EF] py-3 px-5 ">

  ...
  return (
    <div className="pl-[80px] w-full h-auto  flex justify-center ">
      <div className="bg-[#fff] mx-auto flex gap-4 flex-col w-full h-auto scrollbar-thumb-white scrollbar-track-slate-300 px-10">
        {/* <div className="w-auto h-[55px]  pt-5  flex flex-row justify-between ">
          <h2 className='text-3xl font-bold'>Tambah Berita</h2>
        </div> */}

        <div className="grid lg:col-span-3 col-span-3 rounded-xl pt-8 w-auto p-0 gap-5 items-start  content-start">
          ...
          <div className="grid lg:row-span-2 col-span-3 rounded-xl  h-auto w-auto lg:p-6 p-3 gap-7 border-2 border-[#C1C1C1] items-start  content-start">
            <div className="flex w-full justify-center  h-10 auto-cols-min	">
              <h2 className='text-2xl font-bold'>Tambah Berita</h2>
            </div>

            <div className="flex flex-row justify-between gap-8 w-full">
              <div className="flex flex-col gap-4 items-center justify-start w-full">
                <div className="flex flex-row gap-4 items-center justify-between w-full">
                  <span className='min-w-max'>Judul Berita</span>
                  <Input  placeholder="Masukkan Judul berita" className="max-w-[500px] w-full"  />
                </div>
                <div className="flex flex-row gap-4 items-center justify-between w-full">
                  <span className='min-w-max'>Tanggal Berita</span>
                  <Input type="date" className="max-w-[500px] w-full" />
                </div>
                <div className="flex flex-row gap-4 items-start justify-between w-full h-full">
                  <span className='min-w-max'>Konten Berita</span>
                  <Input typeInput="InputMessage" placeholder="Masukkan Judul berita" className="max-w-[600px] w-full h-full" />
                </div>
              </div>

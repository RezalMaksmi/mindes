...
const CardTable = (props) => {
    const {No,JenisKelamin, Agama, Alamat, NomorSurat, NamaPemohon, JenisSurat, Tanggal, ActShow, ActEdit, ActDelete, type, NamaAduan, NamaPelapor} = props
        ...
        role === "admin" && token ? (
          <tr className='border border-[#929292] '>
            ...
            <td className='flex md:flex-row gap-2 w-fit flex-col text-center mx-auto my-2'>
              <Button type="ButtonTextIcon" className="bg-[#90E1DB] items-center text-black " onClick={ActShow} icon={<BiCheckCircle />} text="Proses" />
            </td>
          </tr>  
      ...
      return (
          ...
          role === "admin" && token ? (
              <tr className='border border-[#929292] '>
                ...
                <td className='border border-[#929292] px-2'>{Tanggal}</td>
                <td className='flex md:flex-row gap-2 w-fit flex-col text-center mx-auto my-2'>
                  <Button type="ButtonTextIcon" className="bg-[#FF4E4E] items-center text-white " onClick={ActShow} icon={<BiCheckCircle />} text="Selesai" />
                </td>
              </tr>  

...
const AddAduanUser = () => {
  ...
  return (
    ...
    >
      <div className="bg-[#fff] mx-auto flex gap-4 flex-col w-full h-auto scrollbar-thumb-white scrollbar-track-slate-300 md:px-10 px-3">
        <div
          className="w-auto h-[55px] gap-2 pt-8  flex flex-row justify-start items-center cursor-pointer"
          onClick={() => navigate("/aduan")}
        >
          <ArrowLeft className="md:text-base text-sm" />
          <h2 className="md:text-xl text-base font-semibold">kembali</h2>
        </div>
        ...
        <div className="grid lg:col-span-3 col-span-3 rounded-xl pt-1 w-auto p-0 gap-5 items-start  content-start">
          <div className="grid lg:row-span-2 col-span-3 rounded-xl  h-auto w-auto lg:p-6 p-3 gap-7 border-2 border-[#C1C1C1] items-start  content-start">
            ...
            <div className="flex md:flex-row flex-col justify-between gap-8 w-full">
              <div className="flex flex-col gap-4 items-center justify-start w-full">
                ...
                <div className="flex md:flex-row flex-col  gap-4 items-start justify-between w-full">
                  ...
                  <Input type="date" className="md:max-w-[500px] w-full" />
                </div>
                <div className="flex md:flex-row flex-col  gap-4 items-start justify-between w-full h-full">
                  <span className="min-w-max">Deskripsi Kejadian</span>
                  <Input
                    typeInput="InputMessage"
                    placeholder="Masukkan Deskripsi kejadian"
                    className="max-w-[600px] w-full h-full"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4 items-center justify-between w-full">
                <div
                  className="flex md:flex-row flex-col  gap-4 items-start justify-between w-full"
                  ...
                  {dragging ? (
                    ...
                    <div className="dropzone ">
                      <h1 className="text-base font-bold">
                        Seret dan tempel gambar yang ingin diunggah disini
                      </h1>
                      <span className="text-base ">
                        File yang didukung: JPG,PNG.
                      </span>
                      <input
                        type="file"
            ...
            <div className="flex justify-end">
              <button className="px-3 py-2 rounded-md bg-[#1C305D] w-max text-white">
                Tambah Berita
              </button>
            </div>
          </div>

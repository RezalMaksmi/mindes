...
const Card = ({ image, title, description }) => {
  return (
    <div>
      <div className="flex flex-row md:flex-col justify-center gap-5 items-center shadow-md rounded-lg  hover:scale-105 hover:shadow-xl transition-all p-5 w-full  h-fit md:w-[200px] md:h-[300px] lg:w-[340px] lg:h-[350px]">
        <img
